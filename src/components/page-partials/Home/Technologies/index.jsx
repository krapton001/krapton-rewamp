    ...
    return (
        <section className="py-20 lg:py-56 px-4 xl:px-0 bg-darker">
            ...
            <div className="mx-auto max-w-7xl gap-16 sm:gap-y-24 grid lg:grid-cols-2 lg:items-center bscontainer">
                <div className="z-10">
                    <h3 className="text-primary mb-4 text-3xl sm:text-4xl lg:text-5xl font-bold"><span className='text-white'>Expert in Multiple </span> Technologies with Over 1000+ Projects Completed!</h3>
