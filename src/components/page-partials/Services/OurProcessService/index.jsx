            ...
            <div className="max-w-7xl mx-auto px-4 xl:px-0">
                ...
                <div className="flex flex-col xl:flex-row justify-between py-5 flex-wrap">
                    <div className="relative w-full xl:w-1/2 flex-none block px-0 lg:px-5 xl:px-10">
                        ...
                        <div className="border-2 md:border-4 border-dashed border-primary rounded-[30px] rounded-tr-none rounded-br-none border-r-0 md:border-r-0 h-[130px] w-[80px] sm:h-[190px] sm:w-[170px] sm:max-xl:left-40 top-[10px] left-[30px] absolute">
                        ...
                        <div className="border-2 md:border-4 border-dashed border-primary rounded-[30px] rounded-tl-none rounded-bl-none border-l-0 md:border-l-0 h-[180px] w-[110px] sm:h-[335px] sm:w-[150px] right-5 sm:max-xl:right-48 sm:max-xl:top-56 xl:right-[60px] top-[150px] xl:top-[190px]  absolute">
                        ...
                        <figure className="flex justify-center ">
                            <img alt src="assets/processImages/we-build-web.png" className="w-full sm:max-xl:w-[600px] sm:max-xl:h-[400px] h-auto z-10 object-contain relative" />
                        </figure>
                    ...
                    <div className="relative w-full xl:w-1/2 flex-none block px-10">
                        ...
                        <div className="border-2 md:border-4 border-dashed border-primary rounded-[30px] rounded-tl-none rounded-bl-none border-l-0 md:border-l-0 h-[160px] xl:h-[190px]  w-[120px]  xl:w-[160px] top-[35px] xl:top-[10px] right-[30px] sm:max-xl:right-80 xl:right-[80px] absolute">
                        ...
                        <div className="border-2 md:border-4 border-dashed border-primary rounded-[25px] rounded-tl-none rounded-bl-none border-l-0 md:border-l-0 h-[120px] w-[100px] xl:h-[140px] xl:w-[160px] top-[300px] xl:top-[380px] right-[30px] sm:max-xl:right-80 xl:right-[80px] absolute">
                            <div className="top-[50px] absolute -right-[15px]">
                                <img alt src="assets/processImages/icon-arrow-down.png" className="rounded-full bg-primaryDark border border-gray-500" />
                            </div>
                        </div>
                        <div className="border-2 md:border-4 border-dashed border-primary rounded-[30px] rounded-tr-none rounded-br-none rounded-bl-none border-r-0 md:border-r-0 border-b-0 md:border-b-0 h-[100px] xl:h-[150px] w-[100px] xl:w-[160px] top-[220px] xl:top-[320px] left-[45px] sm:max-xl:left-80 xl:left-[80px] absolute">
                            <div className="-top-[15px] absolute left-[20px] xl:left-[60px]">
                                <img alt src="assets/processImages/icon-arrow-down.png" className="rounded-full bg-primaryDark border border-gray-500 rotate-90" />
                            </div>
                        </div>
                        <div className="absolute top-[270px] left-0 xl:top-[400px] sm:max-xl:left-72 xl:left-10">
                            <img alt src="assets/processImages/we-build-mobile-dart.png" className="h-[96px] w-[96px] object-contain" />
                        </div>
                        <div className="absolute right-0 sm:max-xl:right-72 xl:right-8 top-20 xl:top-auto">
                        ...
                        <div className="flex justify-around flex-wrap mt-10  h-[652px] sm:max-xl:h-[600px] xl:h-[980px] relative">
                            <div className="flex-none w-[45%] xl:w-[40%]">
                    ...
                    <div id="scroll-div" className="relative flex w-full mt-10 sm:max-xl:mt-20 sm:max-xl:h-[700px] h-[600px]">
                        ...
                        <div className="flex flex-col xl:flex-row relative w-full justify-center h-[440px]">
                            <div className="flex order-3 xl:order-none self-center z-10 relative px-20 w-full lg:w-1/2">
                        ...
                        <div className="border-l-2 md:border-l-4 border-dashed border-primary h-[120px] left-[50%] bottom-0 xl:-bottom-20 absolute">
                    ...
                    <div className="flex-none w-full xl:mt-10">
                        <div className="relative text-center sm:max-xl:mb-10">
                            ...
                            <div className="border-l-2 md:border-l-4 border-dashed border-primary h-[80px] left-[50%] bottom-0  sm:-bottom-10 absolute">
