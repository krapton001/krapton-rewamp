    ...
    return (
        <section className="py-20 relative">
            <div className="max-w-7xl mx-auto text-center px-4 xl:px-0">
                <h2 className="text-gray-900 mb-4 text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight"><span className='block'>Upgrade to exceptionality:</span> <span className='bg-gradient'>Discover our elite service offerings.</span></h2>
