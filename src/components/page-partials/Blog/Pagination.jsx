...
const Pagination = ({ pagination }) => {
    ...
    const renderPagination = Array.from({ length: totalPages }, (_, index) => {
        ...
        if (currentPage === page) {
            ...
            return (
                <a href={`/blog/${page}`} key={index + '-pagination'} className="relative inline-flex items-center px-4 py-2 text-sm hover:bg-gray-100  text-gray-900 ring-1 ring-inset ring-gray-300  focus:z-20 focus:outline-offset-0">
                    {page}
                </a>
            );
        }
            ...
            <div className=" flex flex-1 items-center justify-center md:justify-between ">
                ...
                <div>
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        <a href="#" disabled className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
