    ...
    return (
        <section className="lg:max-w-7xl text-center mx-auto mb-5 md:mb-9  pb-32 border-b-2">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 px-4 xl:px-0 gap-8 xl:grid-cols-3 mt-16">
                <div class="max-w-sm rounded-xl min-h-80 bg-white overflow-hidden border relative flex mt-12 items-center justify-center">
                    <div class="px-5 ">
                        <div class="font-light text-3xl text-gray-700 mb-6 ">Hit heavy, stay small</div>
                        <p class="mt-5 text-gray-500 text-lg text-left">Tight-knit, dynamic teams work with more agility, communication, and freedom than large-scale companies.</p>
                    </div>
                </div>
                <div class="max-w-sm rounded-xl min-h-80 bg-white overflow-hidden border relative flex mt-12 items-center justify-center">
                    <div class="px-5 ">
