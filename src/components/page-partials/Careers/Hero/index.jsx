        ...
        <section className="w-full bg-black">
            <div className="max-w-7xl mx-auto lg:min-h-[90vh] items-center flex justify-center px-4 xl:px-0 py-16 lg:py-20">
                <div className="text-center">
                    ...
                    <p className="text-gray-100 my-5 text-2xl font-light">
                        If you&apos;re motivated, intelligent, passionate and looking for a meaningful work environment, Codenia Technologies LLP may just be the last place you send your resume to.
                    </p>
